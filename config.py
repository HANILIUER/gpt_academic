...
API_KEY = "sk-FkBh3DR3zu6yvFCIA6A9Fa0bE7Ac498e8a8b5fA48b073663"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
...
# 格式:API_URL_REDIRECT = {"https://api.openai.com/v1/chat/completions": "https://api.xty.app/v1/chat/completions"}
# 举例:API_URL_REDIRECT = {"https://api.openai.com/v1/chat/completions": "https://api.xty.app/v1/chat/completions"}
